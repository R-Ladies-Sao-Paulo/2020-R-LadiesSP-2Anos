...
Iremos analisar o nosso censo 2020, isso mesmo, nós! Pois a análise será feita ao vivo! 
Comentando escolhas, apresentando bibliotecas e, principalmente, discutindo resultados! 
E para nos ajudar nestas discussões, teremos três convidadas mais que especiais:
Ana Carolina Moreno (Globo), Anycele Santos (AfroPython) e Natalia Souza (Google). 

<!-- aspectos sociodemográficos, econômicos, profissionais e de conhecimento técnico  -->


# Agenda
- Quem são as R-Ladies
- Intro pocket RStudio/Rmarkdown
- Intro Censo R-Ladies
    - conceito de censo/amostra/pesquisa 
- P0
    - conceitual: viés de pesquisa
    - tecnica: leitura dados github/ boa práticas na nomeação de objetos
- P1
    - tecnica: geom_bar/wordcloud
- P2
    - ...
- P3
    - ...
...
censo_cols <- googlesheets4::read_sheet('1ht53wO-qiWsrF3zLIn6DaENNLLjQGqleZL6E6g0lMTc', sheet="nome_colunas")
```
